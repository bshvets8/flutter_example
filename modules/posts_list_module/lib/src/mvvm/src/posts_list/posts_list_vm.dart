...
// Done: Extract to module. Expose only starting widget. Finish sequence from e.g. post details, pass some argument back.
// Done: App bar on main page.

// Done: Move module to 'modules' folder
class PostsListVM extends ChangeNotifier {
  ...
  void init() {
    ...
    // Done: Highlight selected post on list. For tablet only
  }
...
// Done: Repository is responsible only for preparing data.
